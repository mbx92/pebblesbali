...
async function main() {
  ...
  const settings = [
    ...
    { key: 'colorPrimary', value: '#377077' },
    { key: 'colorPrimaryContent', value: '#f0f7f7' },
    { key: 'colorSecondary', value: '#91aaae' },
    { key: 'colorAccent', value: '#c49a6c' },
    { key: 'colorBase100', value: '#f4f0ed' },
    { key: 'colorBaseContent', value: '#1a2e31' },
